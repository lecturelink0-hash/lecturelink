...
const NAV = [
  { href: '/professor/courses', label: '강의 작업공간' },
...
function BookIcon(){return <svg className="professor-book-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/></svg>}
...
export function ProfessorShell({children,displayName,schoolName}:{children:React.ReactNode;displayName:string;schoolName:string|null}){
 ...
 const logo=<Link href="/professor" className="professor-top-logo"><span><BookIcon/></span><b>렉쳐링크</b><small>PROFESSOR</small></Link>;
