    ...
    <div className="professor-dashboard course-library faculty-studio ll-upload-page">
      ...
      <header className="course-library-head page-head">
        <div>
          ...
          <h1>
            한 번의 수업 준비를,
            <br />
            <span className="headline-accent">하나의 차시</span>에서 이어가세요
          </h1>
          <p className="lead">
            차시를 만들면 자료 개선부터 예습자료, 형성평가와 학생 이해도까지
            한곳에 모아 수업 전후의 흐름을 관리할 수 있습니다.
          </p>
        </div>
      </header>
      ...
      <section className="course-library-list">
        <div className="professor-section-head">
          ...
          <p>
            {courses.length > 0
              ? `${courses.length}개의 차시에서 작업을 이어갈 수 있어요`
              : "아래에서 첫 차시를 만들어보세요"}
          </p>
        </div>
          ...
          {courses.map((course, index) => (
            ...
            >
              ...
              <span className="course-card-link">
                이 차시에서 이어서 하기 <ArrowRight size={15} />
              </span>
            </Link>
          ))}
          {!courses.length && (
            <div className="professor-empty">
              아직 만든 차시가 없습니다. 아래에서 첫 차시를 만들면 네 가지 수업
              준비 도구를 한곳에서 관리할 수 있습니다.
            </div>
          )}
        </div>
      </section>
      ...
      <section className="course-create-panel">
        <div className="course-create-copy">
          ...
          <p>
            수업 주제와 학기를 입력하면 자료 제작 결과가 이 차시에 차곡차곡
            저장됩니다.
          </p>
        </div>
