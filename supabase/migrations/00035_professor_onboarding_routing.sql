-- Preserve the account type selected at signup and repair legacy pending professor requests.
...
update public.users
set account_type = 'professor',
    faculty_status = 'approved',
    faculty_approved_at = coalesce(faculty_approved_at, now()),
    faculty_approved_by = null
where account_type = 'student' and faculty_status = 'pending';
