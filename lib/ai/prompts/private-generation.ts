        ...
        items: {
          ...
          properties: {
            ...
            difficulty: {
              ...
              maximum: 3,
              description:
                '이 문항이 실제로 요구하는 인지 수준. 1=재인(한 개념을 그대로 묻는다), 2=적용(두 소견·조건을 통합하거나 표준 처치를 고른다), 3=분석(비전형 양상·수치 해석·2단계 추론·예외와 금기). **요청 난이도에 맞추려 값을 올리거나 내리지 말고, 만들어진 문항의 실제 수준을 정직하게 적는다** — 서버가 요청 난이도와 대조해 품질을 측정한다.',
            },
            ask_kind: {
              type: 'string',
              description:
